...
public abstract class NoteDB extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            noteDao.insert(new Note("Title 1", "Description 1", 1,"aleks"));
            noteDao.insert(new Note("Title 2", "Description 2", 2,"aleks"));
            noteDao.insert(new Note("Title 3", "Description 3", 3,"aleks"));
            return null;
        }
    }
}
